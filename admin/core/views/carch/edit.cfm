...
<cfsilent>
	...
	<div class="mura-actions">
		<div class="form-actions">
			...
			<cfif $.event('frontEnd')>
			 <button type="button" class="btn" onclick="window.location.href='#rc.contentBean.getURL(secure=rc.$.getBean('utility').isHTTPs(),complete=1,queryString='previewid=#rc.contentBean.getContentHistID()#')#';"><i class="mi-close"></i> #esapiEncode('html',application.rbFactory.getKeyValue(session.rb,"sitemanager.content.cancel"))#</button>
			</cfif>
